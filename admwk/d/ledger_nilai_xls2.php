...
//view //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	//query
	$qpel = mysql_query("SELECT m_prog_pddkn.*, m_prog_pddkn_kelas.kd_prog_pddkn AS pelkd ".
...
//			$pel = substr(balikin2($rpel['xpel']),0,35);
			...
			$pel = balikin2($rku['prog_pddkn']);
			$pel_kkm = nosql($rku['kkm']);
	...
	if (!empty($tpel))
		...
		do
			...
			$qku = mysql_query("SELECT * FROM m_prog_pddkn ".
									"WHERE kd = '$pelkd'");
			$rku = mysql_fetch_assoc($qku);			
			$pel = substr(balikin2($rku['xpel']),0,35);
			$pel_kkm = nosql($rku['kkm']);
 ...
 */
	...
	$totalnyax = round($totalku + $totalku2,2);
