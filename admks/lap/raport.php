	...
	if ($ku_no == "1")
		...
		if ($count != 0)
			...
			do
				...
				<td>'.$nama.'</td>
				<td>
				[<a href="raport_xls.php?tapelkd='.$tapelkd.'&kelkd='.$kelkd.'&smtkd='.$smtkd.'&skkd='.$skkd.'" target="_blank" title="Lihat Raport..."><img src="'.$sumber.'/img/xls.gif" width="16" height="16" border="0"></a>]
				</td>
				</tr>';
		  		}
	...
	//jika kurikulum 2013	
		...
		if ($count != 0)
			...
			do
				...
				<td>'.$nama.'</td>
				<td>
				[<a href="raport2_xls.php?tapelkd='.$tapelkd.'&kelkd='.$kelkd.'&smtkd='.$smtkd.'&skkd='.$skkd.'" target="_blank" title="Lihat Raport..."><img src="'.$sumber.'/img/xls.gif" width="16" height="16" border="0"></a>]
				</td>
				</tr>';
		  		}
			while ($data = mysql_fetch_assoc($result));
