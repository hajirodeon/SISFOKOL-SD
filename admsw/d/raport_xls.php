...
//ekstra /////////////////////////////////////////////////////////////////////////////////////////////////////////
$posisi1 = (3 * ($tpel + $tpel2 + $tpel3 + $tpel4)) + 13;
...
do
	...
	$posisi11 = (3 * ($tpel + $tpel2 + $tpel3 + $tpel4)) + 13 + $nomx;
...
//ketidakhadiran /////////////////////////////////////////////////////////////////////////////////////////////////////////
$posisi2 = (3 * ($tpel + $tpel2 + $tpel3 + $tpel4)) + $tkuti + 16;
...
do
	...
	$posisi21 = (3 * ($tpel + $tpel2 + $tpel3 + $tpel4)) + $tkuti + 16 + $nomxz;
...
//bikin kotak
$posisi2 = (3 * ($tpel + $tpel2 + $tpel3 + $tpel4)) + $tkuti + 16 + 1;
$posisi22 = (3 * ($tpel + $tpel2 + $tpel3 + $tpel4)) + $tkuti + 16 + $tabs;
...
//saran wali kelas /////////////////////////////////////////////////////////////////////////////////////////////////////////
$posisi2 = (3 * ($tpel + $tpel2 + $tpel3 + $tpel4)) + $tkuti + 16 + $tabs + 3;
...
//bikin kotak
$posisi2 = (3 * ($tpel + $tpel2 + $tpel3 + $tpel4)) + $tkuti + 16 + $tabs + 4;
$posisi22 = (3 * ($tpel + $tpel2 + $tpel3 + $tpel4)) + $tkuti + 16 + $tabs + 8;
...
//naik ato lulus, ///////////////////////////////////////////////
//posisi
$posisi33 = (3 * ($tpel + $tpel2 + $tpel3 + $tpel4)) + $tkuti + 25 + $tabs;
...
//jika kelulusan
	...
	$posisi34 = (3 * ($tpel + $tpel2 + $tpel3 + $tpel4)) + $tkuti + 25 + $tabs + 1;
	$sheet->setCellValue('C'.$posisi34.'', 'Mengetahui');
	
	$posisi34 = (3 * ($tpel + $tpel2 + $tpel3 + $tpel4)) + $tkuti + 25 + $tabs + 2;
	...
	$posisi34 = (3 * ($tpel + $tpel2 + $tpel3 + $tpel4)) + $tkuti + 25 + $tabs + 6;
